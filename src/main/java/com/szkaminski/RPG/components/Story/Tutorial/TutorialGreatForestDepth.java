...
public class TutorialGreatForestDepth extends Scenario {

    private Observer observer;

    private final String text1 = "Forest Depth placeholder ";
    private Image image;
    private ArrayList<Component> components;
    private List<String> texts;
    private GrandForestDepth grandForestDepth;

    public TutorialGreatForestDepth(Observer observer) {
        this.observer = observer;
        components = new ArrayList<>();
        texts = new ArrayList<>();
        grandForestDepth = new GrandForestDepth(observer);
    }

    public Place getLocation() {
        return grandForestDepth;
    }
