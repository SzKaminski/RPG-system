...
import com.szkaminski.RPG.places.world.grand_forest.GrandForestDeathEnd;
...
public class TutorialGrandForestDeathEnd extends Scenario {

    private Observer observer;

    private final String text1 = "DEATH placeholder ";
    private Image image;
    private ArrayList<Component> components;
    private List<String> texts;
    private GrandForestDeathEnd grandForestDeathEnd;

    public TutorialGrandForestDeathEnd(Observer observer) {
        this.observer = observer;
        components = new ArrayList<>();
        texts = new ArrayList<>();
        grandForestDeathEnd = new GrandForestDeathEnd(observer);
    }

    public Place getLocation() {
        return grandForestDeathEnd;
    }
    ...
    public Image getImage() {
        image = new Image("/images/grandForest2.png", "grandforest");
